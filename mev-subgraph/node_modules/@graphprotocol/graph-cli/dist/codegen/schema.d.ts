...
declare class IdField {
    ...
    typeName(): "string" | "Bytes" | "Int8";
    gqlTypeName(): "Bytes" | "Int8" | "String";
    tsNamedType(): tsCodegen.NamedType;
    tsValueFrom(): "Value.fromBytes(id)" | "Value.fromI64(id)" | "Value.fromString(id)";
    tsValueKind(): "ValueKind.BYTES" | "ValueKind.INT8" | "ValueKind.STRING";
    tsValueToString(): "id.toBytes().toHexString()" | "id.toI64().toString()" | "id.toString()";
    tsToString(): "id.toString()" | "id.toHexString()" | "id";
